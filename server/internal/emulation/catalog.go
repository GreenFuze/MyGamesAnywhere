...
func NewDefaultCatalog() *Catalog {
	catalog, err := NewCatalog([]Emulator{
		...
		{ID: "duckstation", Name: "DuckStation", AdapterState: "ready", SetupProvider: "winget", Platforms: []core.Platform{core.PlatformPS1}, SetupHint: "A legally obtained PlayStation BIOS must be configured in DuckStation before first play.", Capabilities: []CapabilityFact{{ID: "typed_play_route", State: "ready", Details: "MGA starts the selected disc in DuckStation batch fullscreen mode."}, {ID: "firmware", State: "user_required", Details: "Configure a legally obtained PlayStation BIOS in DuckStation."}, {ID: "retroachievements", State: "supported_when_configured"}, {ID: "save_sync", State: "local_files"}}},
