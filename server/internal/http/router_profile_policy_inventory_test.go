...
func TestEveryNonPublicAPIRouteFailsClosedForInvalidProfileSessions(t *testing.T) {
	...
	public := map[string]string{
		...
		"POST /api/devices/pair":                   "public typed client-retired response",
		"POST /api/devices/client-launches/redeem": "public typed client-retired response",
		"GET /api/devices/connect":                 "public typed client-retired response",
		"GET /api/devices/client-download":         "public typed client-retired response",
		"GET /api/devices/client-installer":        "public typed client-retired response",
		"HEAD /api/devices/client-installer":       "public typed client-retired response",
		"GET /api/device-transfers/archive":        "public typed feature-retired response",
		"HEAD /api/device-transfers/archive":       "public typed feature-retired response",
		"GET /api/device-transfers/content":        "public typed feature-retired response",
		"HEAD /api/device-transfers/content":       "public typed feature-retired response",
		"GET /api/device-transfers/file":           "public typed feature-retired response",
		"HEAD /api/device-transfers/file":          "public typed feature-retired response",
		"GET /api/device-transfers/save-domain":    "public typed feature-retired response",
		"PUT /api/device-transfers/save-domain":    "public typed feature-retired response",
