...
func BuildRouter(b *RouteBuilder, middlewareTimeout time.Duration, spaStaticDir string) chi.Router {
	...
	r.Route("/api", func(api chi.Router) {
		if b != nil {
			...
			api.Post("/auth/credential-tickets/redeem", b.AuthCtrl.RedeemCredentialTicket)
			...
			api.Get("/device-transfers/file", b.DeviceCtrl.ServeArchiveTransfer)
			api.Head("/device-transfers/file", b.DeviceCtrl.ServeArchiveTransfer)
			...
			api.Group(func(r chi.Router) {
				...
				r.Post("/devices/{id}/games/{game_id}/download-files", b.DeviceCtrl.DownloadFiles)
				...
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/use-storefront", b.DeviceCtrl.UseStorefrontProduct)
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/launch-storefront", b.DeviceCtrl.LaunchStorefrontProduct)
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/uninstall", b.DeviceCtrl.UninstallGame)
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/repair", b.DeviceCtrl.RepairInstallation)
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/reinstall", b.DeviceCtrl.PrepareInstallationReinstall)
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/cleanup", b.DeviceCtrl.CleanupInstallation)
				r.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/forget", b.DeviceCtrl.ForgetInstallation)
			...
			api.Group(func(r chi.Router) {
				...
				r.Get("/save-sync/domains/{domain_id}/history", b.SaveSyncCtrl.GetDomainHistory)
				r.Put("/save-sync/domains/{domain_id}/history-policy", b.SaveSyncCtrl.SetDomainHistoryPolicy)
				r.Post("/save-sync/history/{version_id}/recover", b.SaveSyncCtrl.RecoverDomainVersion)
			...
			api.Post("/auth/credential-tickets/redeem", noopHandler())
			...
			api.Get("/device-transfers/file", noopHandler())
			api.Head("/device-transfers/file", noopHandler())
			...
			api.Post("/devices/{id}/games/{game_id}/download-files", noopHandler())
			...
			api.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/repair", noopHandler())
			api.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/reinstall", noopHandler())
			api.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/cleanup", noopHandler())
			api.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/forget", noopHandler())
			...
			api.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/use-storefront", noopHandler())
			api.Post("/devices/{id}/games/{game_id}/sources/{source_game_id}/launch-storefront", noopHandler())
			...
			api.Post("/profiles/{id}/credential-tickets", noopHandler())
			api.Get("/profiles/{id}/credential-tickets/active", noopHandler())
			api.Delete("/profiles/{id}/credential-tickets/{ticket_id}", noopHandler())
			...
			api.Get("/save-sync/domains/{domain_id}/history", noopHandler())
			api.Put("/save-sync/domains/{domain_id}/history-policy", noopHandler())
			api.Post("/save-sync/history/{version_id}/recover", noopHandler())
