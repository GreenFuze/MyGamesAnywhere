	...
	r.Route("/api", func(api chi.Router) {
		if b != nil {
			...
			api.Group(func(r chi.Router) {
				...
				r.Put("/media/{assetID}/metadata", b.MediaCtrl.UpdateMediaMetadata)
				...
				r.Post("/review-candidates/{id}/files/delete-preview", b.ReviewCtrl.PreviewDeleteCandidateFiles)
				r.Delete("/review-candidates/{id}/files", b.ReviewCtrl.DeleteCandidateFiles)
