...
const (
	...
	CapabilityGameRecoverInstallation   = "game.recover_installation"
	CapabilityGameUseExisting           = "game.use_existing"
	CapabilityGameUseStorefront         = "game.use_storefront"
	CapabilityGameLaunch                = "game.launch"
	CapabilityGameLaunchStorefront      = "game.launch_storefront"
